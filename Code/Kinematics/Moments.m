...
moments(3).stat = (links(3).m * links(3).r + ...
                   ...
                   motor(4).m * indent4) ...
                   * g;
moments(3).F = (links(3).m + links(4).m + links(5).m +  links(6).m + ...
                   box(1).m + motor(5).m + motor(4).m + motor(3).m) * g;
...
moments(2).J = (links(2).Jx + links(2).m * (links(2).r ^ 2) + ...
                  ...
                  links(5).Jx + links(5).m * ((links(2).L + links(3).L + links(4).L) ^ 2) + ...
                  links(6).Jx + links(6).m * ((links(2).L + links(3).L + links(4).L) ^ 2) + ...
                  box(1).Jx + box(1).m * ((links(2).L + links(3).L + links(4).L) ^ 2) + ...
...
moments(2).stat = (links(2).m * links(2).r + ...
                   ...
                   links(5).m * (links(2).L + links(3).L + links(4).L) + ...
                   links(6).m * (links(2).L + links(3).L + links(4).L) + ...
                   box(1).m * (links(2).L + links(3).L + links(4).L) + ...
                   motor(5).m * (links(2).L + indent5) + ...
                   motor(4).m * (links(2).L + indent4) + ...
                   motor(3).m * links(2).L) ...
                   * g;
moments(2).react = 0;
moments(2).F = (links(2).m + links(3).m + links(4).m + links(5).m +  links(6).m + ...
                   box(1).m + motor(5).m + motor(4).m + motor(3).m) * g;
fprintf("Вес на 2ю ось: %.3fН", moments(2).F);
...
moments(1).J = (links(1).Jz + ...  % вращение вокруг Z (вертикаль)
                  ...
                  links(4).Jy + links(4).m * ((links(2).L + links(3).L + links(4).r) ^ 2) + ...
                  links(5).Jy + links(5).m * ((links(2).L + links(3).L + links(4).L) ^ 2) + ...
                  links(6).Jy + links(6).m * ((links(2).L + links(3).L + links(4).L ) ^ 2) + ...
                  box(1).Jz + box(1).m * ((links(2).L + links(3).L + links(4).L) ^ 2) + ...
