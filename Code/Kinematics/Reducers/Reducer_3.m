...
% 4.1 Выбор двигателя и определение относительного передаточного числа
reducer(8).u = reducer(9).u;
reducer(8).k = reducer(9).k;
reducer(8).C = 3;
reducer(8).t = reducer(9).t;
...
reducer(8).t1 = 0.3 * reducer(9).t;
reducer(8).t2 = 0.3 * reducer(9).t;
reducer(8).t3 = 0.4 * reducer(9).t;
...
reducer(8).Kd = 780;
reducer(8).psibd = reducer(9).psibd;
reducer(8).uHaC = (reducer(9).k - 1)/2;
reducer(8).uHcb = abs(reducer(8).nch / reducer(8).nbh);
reducer(8).Kc = 1.1;

reducer(8).Khbetta = get_Khbetta_Kfbetta(reducer(9).psibd, reducer(9).HBg, reducer(9).HBw, 'VI', 'KH');
reducer(8).Tap = reducer(9).Ta * reducer(9).Khbetta * reducer(9).Kc / reducer(9).C;
reducer(8).da = reducer(9).da;
...
reducer(8).za = reducer(9).za;
reducer(8).m = reducer(9).m;
reducer(8).da = reducer(9).da;
...
% Параметры остальных колес
reducer(8).zb = reducer(9).zb;
reducer(8).zc = reducer(9).zc;
...
% 4.1 Выбор двигателя и определение относительного передаточного числа
reducer(7).u = reducer(9).u;
reducer(7).k = reducer(9).k;
reducer(7).C = 3;
reducer(7).t = reducer(9).t;
...
reducer(7).t1 = 0.3 * reducer(9).t;
reducer(7).t2 = 0.3 * reducer(9).t;
reducer(7).t3 = 0.4 * reducer(9).t;
...
reducer(7).Kd = 780;
reducer(7).psibd = reducer(9).psibd;
reducer(7).uHaC = (reducer(9).k - 1)/2;
reducer(7).uHcb = abs(reducer(7).nch / reducer(7).nbh);
reducer(7).Kc = 1.1;

reducer(7).Khbetta = get_Khbetta_Kfbetta(reducer(9).psibd, reducer(9).HBg, reducer(9).HBw, 'VI', 'KH');
reducer(7).Tap = reducer(9).Ta * reducer(9).Khbetta * reducer(9).Kc / reducer(9).C;
reducer(7).da = reducer(9).da;
...
reducer(7).za = reducer(9).za;
reducer(7).m = reducer(9).m;
reducer(7).da = reducer(9).da;
...
% Параметры остальных колес
reducer(7).zb = reducer(9).zb;
reducer(7).zc = reducer(9).zc;
...
gear2_mass = (3 * reducer2_ro * pi / 4 * (0.3 * reducer(7).ba *  reducer(7).da^2 + ...
    0.25 * reducer(7).C * reducer(7).bc * reducer(7).dc^2)/ 10^9);
