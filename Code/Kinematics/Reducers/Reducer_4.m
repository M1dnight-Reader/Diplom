...
% 4.1 Выбор двигателя и определение относительного передаточного числа
reducer(11).u = reducer(12).u;
reducer(11).k = reducer(12).k;
reducer(11).C = 3;
reducer(11).t = reducer(12).t;
...
reducer(11).t1 = 0.3 * reducer(12).t;
reducer(11).t2 = 0.3 * reducer(12).t;
reducer(11).t3 = 0.4 * reducer(12).t;
...
reducer(11).Kd = 780;
reducer(11).psibd = reducer(12).psibd;
reducer(11).uHaC = (reducer(12).k - 1)/2;
reducer(11).uHcb = abs(reducer(11).nch / reducer(11).nbh);
reducer(11).Kc = 1.1;

reducer(11).Khbetta = get_Khbetta_Kfbetta(reducer(12).psibd, reducer(12).HBg, reducer(12).HBw, 'VI', 'KH');
reducer(11).Tap = reducer(12).Ta * reducer(12).Khbetta * reducer(12).Kc / reducer(12).C;
reducer(11).da = reducer(12).da;
...
reducer(11).za = reducer(12).za;
reducer(11).m = reducer(12).m;
reducer(11).da = reducer(12).da;
...
% Параметры остальных колес
reducer(11).zb = reducer(12).zb;
reducer(11).zc = reducer(12).zc;
...
% 4.1 Выбор двигателя и определение относительного передаточного числа
reducer(10).u = reducer(12).u;
reducer(10).k = reducer(12).k;
reducer(10).C = 3;
reducer(10).t = reducer(12).t;
...
reducer(10).t1 = 0.3 * reducer(12).t;
reducer(10).t2 = 0.3 * reducer(12).t;
reducer(10).t3 = 0.4 * reducer(12).t;
...
reducer(10).Kd = 780;
reducer(10).psibd = reducer(12).psibd;
reducer(10).uHaC = (reducer(12).k - 1)/2;
reducer(10).uHcb = abs(reducer(10).nch / reducer(10).nbh);
reducer(10).Kc = 1.1;

reducer(10).Khbetta = get_Khbetta_Kfbetta(reducer(12).psibd, reducer(12).HBg, reducer(12).HBw, 'VI', 'KH');
reducer(10).Tap = reducer(12).Ta * reducer(12).Khbetta * reducer(12).Kc / reducer(12).C;
reducer(10).da = reducer(12).da;
...
reducer(10).za = reducer(12).za;
reducer(10).m = reducer(12).m;
reducer(10).da = reducer(12).da;
...
% Параметры остальных колес
reducer(10).zb = reducer(12).zb;
reducer(10).zc = reducer(12).zc;
...
gear2_mass = (3 * reducer2_ro * pi / 4 * (0.3 * reducer(10).ba *  reducer(10).da^2 + ...
